...
* hal_get_s(3)
* hal_get_si32(3)
* hal_get_si32_clamped(3)
* hal_get_sint(3)
* hal_getter(3)
* hal_get_ui32(3)
* hal_get_ui32_clamped(3)
* hal_get_uint(3)
* hal_init(3)
...
* hal_param_alias(3)
* hal_param_new(3)
* hal_param_new_bool(3)
* hal_param_new_fake(3)
* hal_param_new_real(3)
* hal_param_new_sint(3)
* hal_param_new_uint(3)
* hal_parport(3)
* hal_pdir_t(3)
* hal_pin_alias(3)
* hal_pin_new(3)
...
* hal_pin_new_uint(3)
* hal_port(3)
* hal_port_buffer_size(3)
* hal_port_clear(3)
* hal_port_peek(3)
* hal_port_peek_commit(3)
* hal_port_read(3)
* hal_port_readable(3)
* hal_port_t(3)
* hal_port_writable(3)
