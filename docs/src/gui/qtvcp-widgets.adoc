...
image::images/qtvcp_machineLogDialog.png["QtVCP MachineLogDialog: Machine and Debugging Logs Dialog Widget",scale="25%"]
...
*`doubleIndicator`*:: With triangle or round LEDs add a second vertical LED.
*`on_color`*::
*`off_color`*::
...
image::images/qtvcp_facing.png["QtVCP Facing: Shown from QtDragon",scale="25%"]
Slab or face a definable area with different strategies.

[[sub:qtvcp:widgets:hole-circle]]
=== Hole Circle

image::images/qtvcp_boltholecircle.png["QtVCP BHC: Shown from QtDragon",scale="25%"]
Drill multiple holes on a bolt hole circle.

[[sub:qtvcp:widgets:hole-enlarge]]
=== Hole Enlarge

image::images/qtvcp_holeenlarge.png["QtVCP Facing: Shown from QtDragon",scale="25%"]
